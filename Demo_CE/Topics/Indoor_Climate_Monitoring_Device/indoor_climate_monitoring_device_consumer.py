...
consumer = client.subscribe('persistent://Smart_Home/Environmental_Monitoring/Indoor_Climate_Monitoring_Device', subscription_name='my-subscription')

while True:
    msg = consumer.receive()
    try:
        print("---Indoor_Climate_Monitoring_Device Consumer received message---")
