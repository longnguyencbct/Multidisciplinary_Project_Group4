...
consumer = client.subscribe('persistent://Smart_Home/Energy_Management/Energy_Monitoring_Device', subscription_name='my-subscription')

while True:
    msg = consumer.receive()
    try:
        print("---Energy_Monitoring_Device Consumer received message---")
