...
Write-Host "Opening a new Command Prompt window for the consumer..."
Start-Process -FilePath "cmd.exe" -ArgumentList "/K docker exec -it init-setup sh -c ""cd Demo_CE/Topics/Air_Quality_Monitor && python air_quality_monitor_consumer.py"""
Write-Host "Consumer window opened."
